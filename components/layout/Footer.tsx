    ...
    <footer className="relative bg-[#001F66] text-white/60">
      ...
      <div className="mx-auto max-w-container px-8 pb-10 pt-[60px] max-[640px]:px-5">
        <div className="grid gap-10 border-b border-dark-line pb-12 md:grid-cols-[1.6fr_1fr_1.4fr] max-[760px]:grid-cols-1">
          <div>
            <h2 className="mb-3 text-[11px] font-medium uppercase tracking-[0.18em] text-white/55">
              Address
            </h2>
        ...
        <div className="flex flex-wrap justify-between gap-4 pt-7 text-[12.5px] text-white/55">
