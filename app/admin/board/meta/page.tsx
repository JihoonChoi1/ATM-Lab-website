...
export const metadata: Metadata = { title: "Board 페이지 메타 · ATM Lab" };
...
export default async function BoardMetaPage({
  ...
  return (
    <div className="mx-auto w-full max-w-[640px]">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-[-0.02em]">Board 페이지 메타</h1>
        <p className="mt-1 text-sm text-ink-3">
          공개 /board 상단의 Hero 제목과 소개 문단입니다.
        </p>
      </div>
