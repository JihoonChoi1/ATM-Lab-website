...
export const metadata: Metadata = { title: "Publications 페이지 메타 · ATM Lab" };
...
export default async function PublicationsMetaPage({
  ...
  return (
    <div className="mx-auto w-full max-w-[640px]">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-[-0.02em]">Publications 페이지 메타</h1>
        <p className="mt-1 text-sm text-ink-3">
          공개 /publications 상단의 Hero 제목과 소개 문단입니다.
        </p>
      </div>
